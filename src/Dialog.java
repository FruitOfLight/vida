...
public class Dialog{
    ...
    static void vyhlasChybu(String chybovaSprava){
         JOptionPane.showMessageDialog(null, chybovaSprava,"Chyba",JOptionPane.ERROR_MESSAGE);
    }
    
    static void vyhlasSpravu(String sprava){
         JOptionPane.showMessageDialog(null, sprava,"Správa",JOptionPane.PLAIN_MESSAGE);
    }
